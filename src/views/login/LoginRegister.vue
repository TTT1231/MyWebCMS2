...
<template>
   <div class="flex flex-col" v-show="isShow">
      <span class="font-bold text-xl flex justify-center xl:justify-start animate-enterx-faster">{{
      ...
      <el-form
         ...
         class="py-4 xl:ml-4"
      >
         <el-form-item :label="$t('login.account')" prop="account" class="animate-enterx-medspeed">
         ...
         <el-form-item :label="$t('login.phone')" prop="mobile" class="animate-enterx-medspeed">
            <el-input
               type="password"
      ...
      <div>
         <el-button class="w-full mt-4 animate-enterx-medspeed ease-out" @click="handleBack">{{
            $t('login.back')
         }}</el-button>
      </div>
   </div>
