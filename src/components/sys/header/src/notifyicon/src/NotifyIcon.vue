...
import { IMGHOME } from '@/enums/globalEnums';
import { computed } from 'vue';
import { ref } from 'vue';
import type { TabsProps } from 'ant-design-vue';
import { listData } from './data';

const reactiableImagePath = `${IMGHOME}/sys/header/notify.png`;
...
<template>
   <div
      class="h-full hover:cursor-pointer hover:bg-black/20 flex items-center w-12 justify-center"
      @click="handleNotify"
   >
      <a-badge :dot="true">
